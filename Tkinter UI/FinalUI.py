...
master = tk.Tk()
master.title("Analyse and Predict Admission")
master.configure(background = "#1A5276")
master.resizable(width = False, height = False);

df = pd.read_csv('Admission Prediction 11.csv')
X = df[['GRE Score','TOEFL Score','University Rating','SOP','CGPA','Research']]
y = df['Chance of Admission']
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.2, random_state=101)

lm = RandomForestRegressor(n_estimators=110,max_depth=6,random_state=0)
...
def predict() :
    ...
    if (g>260 and t>70 and c>6.9):
       ...
       p= tk.Label(master, text="Chance of Admission: " + str(prd),width=25,height = 4,
                   bg = "#1A5276",fg = "WHITE",font = "Candara").grid(row=8, column=0)

       plt.xlabel('Y Test')
       plt.ylabel('Predicted Y')
       
    else:
       p= tk.Label(master, text="The candidate is not eligible.",width=25,height = 4,
                   bg = "#1A5276",fg = "WHITE",font = "Candara").grid(row=8, column=0)
...
def analysis():
    ...
    def Img1():
        ...
        canvas1 = Canvas(r1, height=388, width=502)
        canvas1.pack()
    ...
    def Img2():
        ...
        canvas2 = Canvas(r2, height=388, width=1175)
        canvas2.pack()
    ...
    def Img3():
        ...
        canvas3 = Canvas(r3, height=388, width=1181)
        canvas3.pack()
    ...
    def Img4():
        ...
        canvas4 = Canvas(r4, height=453, width=575)
        canvas4.pack()
    ...
    def Img6():
        ...
        canvas6 = Canvas(r6, height=466, width=1000)
        canvas6.pack()
    ...
    def Img7():
        ...
        canvas7 = Canvas(r7, height=480, width=640)
        canvas7.pack()
    ...
    btn = Button(root, text = "Correlation Between All Columns",width=32,height = 3,font = "Copperplate_Gothic", 
                 fg = "BLACK",bg = "#C0392B", command = Img)
    btn.grid(row = 0, column = 0)
    
    btn1 = Button(root, text = "Research Experience Analysis",width=32,height = 3,font = "Copperplate_Gothic", 
                  fg = "BLACK",bg = "#C0392B", command = Img1)
    btn1.grid(row = 1, column = 1)

    btn2 = Button(root, text = "TOEFL Score Analysis",width=32,height = 3,font = "Copperplate_Gothic", 
                  fg = "BLACK",bg = "#C0392B", command = Img2)
    btn2.grid(row = 2, column = 0)

    btn3 = Button(root, text = "GRE Score Analysis", width=32,height = 3,font = "Copperplate_Gothic", 
                  fg = "BLACK",bg = "#C0392B",command = Img3)
    btn3.grid(row = 3, column = 1)

    btn4 = Button(root, text = "CGPA Score Analysis_1",width=32,height = 3,font = "Copperplate_Gothic", 
                  fg = "BLACK",bg = "#C0392B", command = Img4)
    btn4.grid(row = 4, column = 0)

    btn5 = Button(root, text = "CGPA Score Analysis_2",width=32,height = 3,font = "Copperplate_Gothic", 
                  fg = "BLACK",bg = "#C0392B", command = Img5)
    btn5.grid(row = 5, column = 1)

    btn6 = Button(root, text = "University Rating Analysis",width=32,height = 3,font = "Copperplate_Gothic", 
                  fg = "BLACK",bg = "#C0392B", command = Img6)
    btn6.grid(row = 6, column = 0)

    btn7 = Button(root, text = "SOP vs CGPA",width=32,height = 3,font = "Copperplate_Gothic", 
                  fg = "BLACK",bg = "#C0392B", command = Img7)
    btn7.grid(row = 7, column = 1)

    btn8 = Button(root, text = "SOP vs GRE Score",width=32,height = 3,font = "Copperplate_Gothic", 
                  fg = "BLACK",bg = "#C0392B", command = Img8)
...
btn = tk.Button(master, text = 'Predict', width=32,height = 3,font = "Copperplate_Gothic", 
                fg = "BLACK",bg = "#C0392B" , command = predict).grid(row = 6, column = 1)
btn1 = tk.Button(master, text = 'Analyse', width=32,height = 3,font = "Copperplate_Gothic", 
                 fg = "BLACK",bg = "#C0392B" , command = analysis).grid(row = 6, column = 0)
